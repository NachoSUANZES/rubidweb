...
import { X, TrendingUp, Users, Clock, Zap, Target, Activity, Globe, Shield, Cpu, Terminal, MessageSquare, BarChart3 } from 'lucide-react';
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-5xl bg-[#050505] border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col h-[85vh] md:h-auto md:max-h-[90vh] z-[110]"
                    >
                        {/* Header */}
                                ...
                                <div className="space-y-8 max-w-3xl">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2 text-green-500 mb-2 text-xs uppercase tracking-widest font-bold">
                                            <TrendingUp size={14} /> 03. Abrumadora Eficacia
                                        </div>
                                    ...
                                    <div className="pt-8">
                                        <button className="px-6 py-3 bg-white text-black font-bold text-sm hover:bg-gray-200 transition-colors rounded uppercase tracking-wider w-full md:w-auto">
